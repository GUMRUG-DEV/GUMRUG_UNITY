...
public class HousealsoScript : MonoBehaviour {
    ...
    void Start () {
        ...
        Door.col_Box = GameObject.Find("DoorInside").GetComponent<BoxCollider2D>();
    }
	...
	void Update () {
        ...
        {
            SceneManager.LoadScene("FirstLevel - OutsideF");
        }
    }
}
